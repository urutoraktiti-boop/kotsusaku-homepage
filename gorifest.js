/* ============================================================================
   ...
   ★ 2026-08-15、55,555時間を達成しました。現在お祭りを開催中です。
     2026-08-31 を過ぎると、何もしなくても自動で通常の見た目に戻ります。
     早く終わらせたいときは、下の on を false にしてください。
     （新キャラのゴリゴゴ・ゴリウーは常時表示なので、on の値に関係なく出ます）
   ============================================================================ */
var GORIFEST = { on: true, until: '2026-08-31' };
